...
let currentQR = null;
let isReady = false;
// URL del webhook de n8n. Se usará GET para enviar parámetros "phone", "message" y "timestamp".
// Reemplaza la URL a continuación por la que corresponda.
...
// Endpoint para guardar la configuración del Webhook avanzado y probarla (este endpoint es para pruebas)
...
// Endpoint para enviar un mensaje (utilizado también por aplicaciones externas)
